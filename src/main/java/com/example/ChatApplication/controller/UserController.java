...
public class UserController {
    ...
    public ResponseEntity<String> createUser(@RequestBody String userData) {
        //List<Users> users=userRespository.findFirstName("Raeyan");
    ...
    @PostMapping("login")
    public ResponseEntity<String> login(@RequestBody String responsedata)
    {
        JSONObject requestJson=new JSONObject(responsedata);
    ...
    public ResponseEntity<String> upadte(@PathVariable String userId,@RequestBody String requestData)
    {
    ...
    private JSONObject validateUserRequest(String userData) {
        ...
        if(userJson.has("username")) {
            ...
            List<User> userlist=userRespository.findFirstName(username);
            if(!userlist.isEmpty())
            {
                errorList.put("username", "This user already exits");
            }
